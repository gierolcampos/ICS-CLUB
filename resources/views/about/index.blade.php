        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100">
                <div class="flex items-center mb-4">
                    <div class="bg-indigo-100 p-3 rounded-full border border-indigo-200 mr-4">
            ...
            <div class="px-6 py-8 sm:p-10">
                ...
                <div class="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div class="bg-indigo-50 p-4 rounded-lg text-center">
                        <div class="text-3xl font-bold text-indigo-600">2005</div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-gray-50 rounded-lg overflow-hidden shadow-sm">
                        <div class="p-4 text-center">
                            <div class="w-24 h-24 rounded-full bg-indigo-600 mx-auto mb-4 flex items-center justify-center text-white text-2xl font-bold">
                                JP
                            </div>
        ...
        <div class="bg-gray-900 rounded-xl shadow-xl overflow-hidden mb-6">
            <div class="px-6 py-8 sm:p-10">
                <div class="text-center">
                    ...
                    <div class="mt-8">
                        <a href="#" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-indigo-600 bg-white hover:bg-indigo-50 transition">
                            Join Our Community
                        </a>
                    </div>
                </div>
