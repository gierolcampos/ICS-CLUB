                    ...
                    <div id="cash-fields" class="space-y-6 bg-gray-50 p-6 rounded-lg border border-gray-200" style="display: none;">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="officer_in_charge" name="officer_in_charge" value="{{ old('officer_in_charge') }}" class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Enter officer's name">
                            ...
                            <div>
                                ...
                                <input type="text" id="receipt_control_number" name="receipt_control_number" value="{{ old('receipt_control_number') }}" class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Enter receipt control number">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function(e) {
            ...
            if (paymentMethod === 'CASH') {
                const officerInCharge = document.getElementById('officer_in_charge').value.trim();
                const receiptNumber = document.getElementById('receipt_control_number').value.trim();
                
                if (!officerInCharge || !receiptNumber) {
                    e.preventDefault();
                    alert('Please fill in all required cash payment details');
                    return;
                }
